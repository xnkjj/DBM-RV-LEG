...
local sndDSA	= mod:SoundMM("SoundDSA")
...
local warnDelirious				= mod:NewTargetAnnounce(117837, 4, nil, mod:IsTank())--Heroic Ability
--Qiang
...
local specWarnDelirious			= mod:NewSpecialWarningDispel(117837, mod:IsTank())--Heroic Ability
--Qiang
...
local timerDeliriousCD			= mod:NewCDTimer(20.5, 117837)
--Qiang
