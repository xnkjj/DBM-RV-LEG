...
langs.zhTW = {
	...
	config_progressTooltip = "在敵人的滑鼠提示中顯示他所提供的進度",
	...
	config_autoGossip = "在傳奇鑰石副本中自動選擇對話選項 (例如: 歐丁)",
	...
	timeLost = "損失時間",
	config_persistTracker = "副本完成後繼續顯示任務追蹤（重新載入後生效）",
	scheduleTitle = "時程表",
	scheduleWeek1 = "本週",
	scheduleWeek2 = "下週",
	scheduleWeek3 = "兩週後",
	scheduleWeek4 = "三週後",
	scheduleMissingKeystone = "要顯示時程表，背包中必須要有傳奇難度 7+ 的鑰石。",
	config_exclusiveTracker = "在副本中隱藏成就和任務追蹤（重新載入後生效）",
	config_hideTalkingHead = "在傳奇鑰石副本中隱藏說話的頭",
	config_resetPopup = "完成傳奇鑰石副本後顯示重置副本的彈出訊息",
	addon_name = "傳奇+",
}
