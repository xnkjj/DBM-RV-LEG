...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS = {
	...
	switch2			= "Show special warning to switch targets when someone is affected by $spell:%s",
...
DBM_CORE_AUTO_YELL_OPTION_TEXT = {
	...
	fademoveaway	= "Yell (with countdown and spell name) when $spell:%s is fading",
...
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT = {
	...
	fade			= "%s fading in %%d",
	fademoveaway	= "%s fading in %%d! GO AWAY FROM ME!",
	shortfade		= "%%d",
	iconfade		= "{rt%%2$d}%%1$d",
